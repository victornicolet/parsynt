...
val build : FuncTypes.fnExpr -> FuncTypes.VarSet.t ->
  FuncTypes.fnExpr -> (FuncTypes.fnV * FuncTypes.fnV) -> FuncTypes.fnExpr
val build_for_inner :
  FuncTypes.fnExpr -> FuncTypes.VarSet.t ->
  FuncTypes.fnExpr Utils.IM.t -> FuncTypes.fnExpr ->
  (FuncTypes.fnV * FuncTypes.fnV) -> FuncTypes.fnExpr
