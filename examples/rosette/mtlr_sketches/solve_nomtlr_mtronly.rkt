...
;; cpu time: 232 real time: 119186 gc time: 24
;; /home/nicolet/repositories/parsynth/examples/rosette/mtlr_sketch_colmax.rkt:134:0
;; '(define (__join__ $Vi_Vi_iiL $Vi_Vi_iiR i_start i_end)
;;    (let ((l.c ($Vi_Vi_ii-c $Vi_Vi_iiL))
;;          (l.colmax ($Vi_Vi_ii-colmax $Vi_Vi_iiL))
;;          (l.mtr ($Vi_Vi_ii-mtr $Vi_Vi_iiL))
...
;;                       (max
;;                        (max mtr (list-ref c j))
;;                        (- (list-ref l.c j) (list-ref colmax j)))
;;                       r.sum))))))))
;;        tup$)))
